...
ll Recurse(ll n, ll num){
    if(IsNContains7(n)){
        return 0;
    }
    return 1+Recurse(n + num, num);
}
void solve(ll n){
    ll num=0;
...
void solve(ll n, ll k, ll l, ll r, vll& a){
}

void solve(ll n, ll m, ll k, vll& a, vll& b, string s){
}
int main() {     
